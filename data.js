    ...
    home: {
      ...
      programs: [
        ...
        },
        {
          ...
          badge: "Volunteers",
          description: "Guides, templates, and mentorship to run consistent, safe, and welcoming sessions.",
          ctaLabel: "See resources",
          ctaHref: "coaches.html"
        }
      ],
      galleryTag: "Gallery",
      ...
      streams: [
        {
          ...
          description:
            "Our U8 and U10 programs focus on fundamentals and fun. Short games, high ball touches, and coaches who prioritise encouragement.",
          links: [{ label: "Email registrar", href: "mailto:registrar@westbasketball.com.au" }]
        },
        {
          id: "juniors",
          title: "Juniors (U12-U18)",
          ...
          description:
            "Junior squads (U12-U18) train weekly with structured plans for skills, decision making, and fitness. Grading and team lists are updated each season.",
          links: [
            { label: "Grading details", href: "https://example.com/grading" },
            { label: "Training schedule", href: "https://example.com/training" }
          ]
        }
      ],
